              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 mt-1 text-xs text-violet-600 hover:text-violet-700"
                  >
                    ...
                    <div className="mt-2 pt-2 border-t border-slate-200 space-y-1 text-xs">
                      {dispute.plaintiff && dispute.plaintiff !== '-' && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-slate-600">{language === 'zh' ? '原告：' : 'Plaintiff: '}</span>
                      ...
                      {dispute.defendant && dispute.defendant !== '-' && (
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-slate-600">{language === 'zh' ? '被告：' : 'Defendant: '}</span>
